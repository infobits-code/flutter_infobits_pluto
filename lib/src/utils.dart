...
List<PlutoTrace> getStackTraceElements(StackTrace stackTrace) {
  final List<PlutoTrace> elements = <PlutoTrace>[];
    ...
    if (frame is UnparsedFrame) {
      if (kIsWeb) {
        ...
        if (_obfuscatedStackTraceLineRegExp.hasMatch(frame.member)) {
          ...
          elements.add(PlutoTrace(file: "", line: 0, method: method));
        }
      }
    } else {
      final PlutoTrace element = PlutoTrace(
        file: frame.library,
        line: frame.line ?? 0,

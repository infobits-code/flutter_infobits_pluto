...
/// [PlutoRenderErrorBox.backgroundColor] static property.
///
...
/// [PlutoRenderErrorBox.textStyle] and [PlutoRenderErrorBox.paragraphStyle] static
/// properties.
///
...
class PlutoRenderErrorBox extends RenderBox {
  ...
  PlutoRenderErrorBox([this.message = '']) {
    try {
      if (message != '') {
  ...
  ///
  /// This is intended to ensure that if the [PlutoRenderErrorBox] is placed at the top left
  ...
  /// The color to use when painting the background of [PlutoRenderErrorBox] objects.
  ///
  ...
  /// The text style to use when painting [PlutoRenderErrorBox] objects.
  ///
  ...
  /// The paragraph style to use when painting [PlutoRenderErrorBox] objects.
